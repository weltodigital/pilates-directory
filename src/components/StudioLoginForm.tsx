    ...
    return (
      <div className="card-flat mx-auto max-w-md p-8 text-center">
        ...
        <p className="mt-4 text-sm text-ink-faint">
          Nothing arrived? Check your spam folder, or email us and we&apos;ll help.
        </p>
      </div>
    );
  }
  ...
  return (
    <form onSubmit={onSubmit} className="card-flat mx-auto max-w-md p-8">
      ...
      <p className="mt-5 text-center text-xs leading-relaxed text-ink-faint">
        No password to remember. We send a link instead, which is also how we know
        the address really is yours.
      </p>
    </form>
  );
}
