...
INSERT INTO recipes (
  ...
  '[{"ingredient": "all-purpose flour", "amount": "2 1/4 cups"}, {"ingredient": "baking soda", "amount": "1 tsp"}, {"ingredient": "salt", "amount": "1 tsp"}, {"ingredient": "butter, softened", "amount": "1 cup"}, {"ingredient": "brown sugar", "amount": "3/4 cup"}, {"ingredient": "white sugar", "amount": "3/4 cup"}, {"ingredient": "eggs", "amount": "2 large"}, {"ingredient": "vanilla extract", "amount": "2 tsp"}, {"ingredient": "chocolate chips", "amount": "2 cups"}]',
  '[{"step": 1, "instruction": "Preheat oven to 375°F (190°C)."}, {"step": 2, "instruction": "Mix flour, baking soda, and salt in a bowl."}, {"step": 3, "instruction": "In another bowl, cream butter and both sugars until fluffy."}, {"step": 4, "instruction": "Beat in eggs and vanilla."}, {"step": 5, "instruction": "Gradually blend in flour mixture."}, {"step": 6, "instruction": "Stir in chocolate chips."}, {"step": 7, "instruction": "Drop rounded tablespoons onto ungreased cookie sheets."}, {"step": 8, "instruction": "Bake 9-11 minutes or until golden brown."}, {"step": 9, "instruction": "Cool on baking sheet for 2 minutes, then transfer to wire rack."}]',
  15,
  10,
  25,
  48,
...
INSERT INTO recipes (
  ...
  '[{"ingredient": "spaghetti", "amount": "400g"}, {"ingredient": "pancetta or bacon", "amount": "150g, diced"}, {"ingredient": "eggs", "amount": "3 large"}, {"ingredient": "Parmesan cheese, grated", "amount": "100g"}, {"ingredient": "black pepper", "amount": "1 tsp, freshly ground"}, {"ingredient": "salt", "amount": "to taste"}]',
  '[{"step": 1, "instruction": "Bring a large pot of salted water to boil and cook spaghetti according to package directions."}, {"step": 2, "instruction": "While pasta cooks, fry pancetta in a large pan until crispy."}, {"step": 3, "instruction": "In a bowl, whisk together eggs, Parmesan, and black pepper."}, {"step": 4, "instruction": "Reserve 1 cup pasta water before draining."}, {"step": 5, "instruction": "Add hot pasta to the pan with pancetta."}, {"step": 6, "instruction": "Remove from heat and quickly stir in egg mixture."}, {"step": 7, "instruction": "Add pasta water gradually until creamy."}, {"step": 8, "instruction": "Serve immediately with extra Parmesan and black pepper."}]',
  10,
  15,
  25,
  4,
...
INSERT INTO recipes (
  ...
  '[{"ingredient": "chicken breast, sliced thin", "amount": "500g"}, {"ingredient": "mixed vegetables (bell peppers, broccoli, carrots)", "amount": "400g"}, {"ingredient": "soy sauce", "amount": "3 tbsp"}, {"ingredient": "garlic, minced", "amount": "3 cloves"}, {"ingredient": "ginger, minced", "amount": "1 tbsp"}, {"ingredient": "vegetable oil", "amount": "2 tbsp"}, {"ingredient": "cornstarch", "amount": "1 tbsp"}, {"ingredient": "sesame oil", "amount": "1 tsp"}]',
  '[{"step": 1, "instruction": "Heat vegetable oil in a large wok or skillet over high heat."}, {"step": 2, "instruction": "Add chicken and cook until golden, about 3-4 minutes."}, {"step": 3, "instruction": "Add garlic and ginger, stir for 30 seconds."}, {"step": 4, "instruction": "Add vegetables and stir-fry for 3-4 minutes."}, {"step": 5, "instruction": "Mix soy sauce and cornstarch, add to pan."}, {"step": 6, "instruction": "Stir until sauce thickens, about 1 minute."}, {"step": 7, "instruction": "Drizzle with sesame oil and serve over rice."}]',
  10,
  8,
  18,
  4,
...
INSERT INTO recipes (
  ...
  '[{"ingredient": "all-purpose flour", "amount": "2 1/2 cups"}, {"ingredient": "baking powder", "amount": "2 1/2 tsp"}, {"ingredient": "salt", "amount": "1/2 tsp"}, {"ingredient": "butter, softened", "amount": "1 cup"}, {"ingredient": "sugar", "amount": "1 3/4 cups"}, {"ingredient": "eggs", "amount": "4 large"}, {"ingredient": "vanilla extract", "amount": "2 tsp"}, {"ingredient": "milk", "amount": "1 1/4 cups"}]',
  '[{"step": 1, "instruction": "Preheat oven to 350°F (175°C). Grease two 9-inch round pans."}, {"step": 2, "instruction": "Mix flour, baking powder, and salt in a bowl."}, {"step": 3, "instruction": "Cream butter and sugar until light and fluffy, about 4 minutes."}, {"step": 4, "instruction": "Beat in eggs one at a time, then vanilla."}, {"step": 5, "instruction": "Alternate adding flour mixture and milk, beginning and ending with flour."}, {"step": 6, "instruction": "Divide batter between prepared pans."}, {"step": 7, "instruction": "Bake 25-30 minutes until a toothpick comes out clean."}, {"step": 8, "instruction": "Cool in pans 10 minutes, then turn out onto wire racks."}]',
  20,
  30,
  50,
  12,
...
INSERT INTO recipes (
  ...
  '[{"ingredient": "beef stew meat", "amount": "2 lbs, cubed"}, {"ingredient": "potatoes", "amount": "4 large, cubed"}, {"ingredient": "carrots", "amount": "4 large, sliced"}, {"ingredient": "onion", "amount": "1 large, diced"}, {"ingredient": "beef broth", "amount": "3 cups"}, {"ingredient": "tomato paste", "amount": "2 tbsp"}, {"ingredient": "Worcestershire sauce", "amount": "1 tbsp"}, {"ingredient": "garlic powder", "amount": "1 tsp"}, {"ingredient": "dried thyme", "amount": "1 tsp"}, {"ingredient": "salt and pepper", "amount": "to taste"}, {"ingredient": "cornstarch", "amount": "2 tbsp"}, {"ingredient": "water", "amount": "2 tbsp"}]',
  '[{"step": 1, "instruction": "Add beef, potatoes, carrots, and onion to slow cooker."}, {"step": 2, "instruction": "Mix broth, tomato paste, Worcestershire, garlic powder, and thyme."}, {"step": 3, "instruction": "Pour mixture over ingredients in slow cooker."}, {"step": 4, "instruction": "Season with salt and pepper."}, {"step": 5, "instruction": "Cover and cook on low 8 hours or high 4 hours."}, {"step": 6, "instruction": "Mix cornstarch and water to make slurry."}, {"step": 7, "instruction": "Stir slurry into stew and cook 15 minutes more to thicken."}, {"step": 8, "instruction": "Taste and adjust seasoning before serving."}]',
  15,
  480,
  495,
  6,
